...
driver.find_element_by_xpath('/html/body/div/div[4]/div/div/div[2]/form/fieldset/div[2]/input').send_keys('news')
driver.find_element_by_xpath('/html/body/div/div[4]/div/div/div[2]/form/fieldset/div[3]/textarea').send_keys('Hi Samy! How are you?')
