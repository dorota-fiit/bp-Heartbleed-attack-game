...
# 
# Students can use eg. "./attack.py www.heartbleedlabelgg.com " to send the heartbeat request
...
options.add_option('-l', '--length', type='int', default=0x16,dest="len", help='payload length to test (default: 0x16)')
